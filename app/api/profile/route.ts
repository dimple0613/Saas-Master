...
export async function GET() {
  ...
  return NextResponse.json({
    ...
    company_first_name: user.companyFirstName,
    company_last_name: user.companyLastName,
  ...
  try {
    ...
    await prisma.user.update({
      ...
      data: {
        ...
        companyFirstName: body.company_first_name != null ? String(body.company_first_name) : undefined,
        companyLastName: body.company_last_name != null ? String(body.company_last_name) : undefined,
        companyEmail: body.company_email != null ? String(body.company_email) : undefined,
