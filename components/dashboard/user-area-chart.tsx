    ...
    <Card>
      <CardHeader className="flex flex-row items-center justify-between pb-2">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Your activity over time</p>
        </div>
      </CardHeader>
      <CardContent>
        <ChartContainer config={chartConfig} className="h-[300px] w-full aspect-auto">
          <AreaChart data={data}>
            ...
            <defs>
              <linearGradient id="fillMyActivity" x1="0" y1="0" x2="0" y2="1">
                <stop offset="5%" stopColor="var(--color-chart-1)" stopOpacity={0.8} />
                <stop offset="95%" stopColor="var(--color-chart-1)" stopOpacity={0.05} />
              </linearGradient>
            </defs>
            <Area type="monotone" dataKey="value" stroke="var(--color-chart-1)" fill="url(#fillMyActivity)" strokeWidth={2} />
          </AreaChart>
        </ChartContainer>
      </CardContent>
    </Card>
